  ...
  return (
    <main className="flex-grow flex items-center justify-center pt-24 pb-16 px-4 bg-gray-50">
      ...
      >
        ...
        <p className="text-gray-500 text-sm mb-8">Sign in to access your account, wishlist, and orders.</p>
        ...
        >
          ...
          <span className="text-sm font-medium uppercase tracking-widest">Continue with Google</span>
        </button>
